...
// Function to check if the user ID exists in the user_form table
function doesUserIDExist($userID) {
    global $conn;
    $query = "SELECT id FROM user_form WHERE id = ?";
...
.casesnavcontainer  #actionsDropdown  {
    display: none;
    position: absolute;
...
<div class="main--content">
        ...
        <div class="casesheader" id="casesheader">
            <div class="casesnavcontainer">
                <h2 class="casenumber">Case <span><?php echo $defaultCaseNumber; ?></span></h2><br> <br>
...
<div id="checkoutModal" class="modal">
  <div class="modal-content">
    ...
    <table class="table-bordered">
        ...
        <tbody>
        <?php
           $query = "SELECT case_number, category, evidence_id, description, status, storage_location FROM evidence WHERE case_number = '$defaultCaseNumber'";
           ...
           if($result){
              ...
              ?>
                ...
                <a href="adminitemview.php?evidence_id=<?php echo $evidenceid; ?>" class="btn"> View </a>
