...
<div class="main--content">
        ...
        <div class="main--content">
    <div class="header--wrapper">
    <h3>Case Permissions</h3>
        <table class="case-permissions-table">
            <thead>
                <tr>
                    <th>Case ID</th>
                    <th>Case Name</th>
            ...
            <tbody>
                <!-- Display existing case permissions dynamically here -->
            </tbody>
        </table>
        <!-- Header Title and User Info -->
        <div class="actions">
    <button id="add-permission-btn">Add New Permission</button>
    <!-- Add other action buttons here -->
</div>
    </div>
    <div class="case-permissions">
