...
<form action="" method="post" >
   <div class="flex">
      <div class="inputBox">
         ...
         <span>Category:</span><input type="text" name="category"placeholder="--Enter category"  class="box">
      </div>
   </div>
   <input type="submit" value="Next" name="add_item" class="btn">
</form>
